...
int main(void)
{
	...
	// NEED TO LOAD A SCENARIO AT THE START
	//load_scenario_data();
	set_up_terrain_buttons();
	
	redraw_screen();

//extract_old_scen_text();
...
void handle_town_menu(int item_hit)
{
	...
	switch (item_hit) {
		case 1: // laod new town
			...
			break;
		case 2: edit_town_details(); change_made_town = TRUE; set_up_terrain_buttons(); draw_main_screen(); break; // Town Details
